...
下图是MySQL的基本架构示意图，从中你可以清楚地看到SQL语句在MySQL的各个功能模块中的执行过程。

![adp](../../../.vuepress/public/image/mysql1-3.png)
...
![adp](../../../.vuepress/public/image/mysql2-2.png)
...
binlog用于记录数据库执行的“写操作”(例如：insert、update、delete、alert等DDL、DML，但不包括查询操作)信息，并以二进制的形式保存在磁盘中。

binlog是mysql的**逻辑日志**，并且由Server层进行记录，与存储引擎无关，任何存储引擎的mysql数据库都会记录binlog日志
...
![adp](../../../.vuepress/public/image/mysql2-3.png)
...
![adp](../../../.vuepress/public/image/mysql2-4.png)
...
两阶段提交事实上就是为binlog和redolog一起形成了一个事物，保证了他们的一致性。

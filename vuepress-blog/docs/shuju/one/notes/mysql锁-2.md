...
![adp](../../../.vuepress/public/image/mysql7-1.png)
...
![adp](../../../.vuepress/public/image/mysql7-2.png)
...
![adp](../../../.vuepress/public/image/mysql7-3.png)
...
![adp](../../../.vuepress/public/image/mysql7-4.png)
...
![adp](../../../.vuepress/public/image/mysql7-5.png)
...
![adp](../../../.vuepress/public/image/mysql7-6.png)
...
![adp](../../../.vuepress/public/image/mysql7-7.png)
...
![adp](../../../.vuepress/public/image/mysql7-8.png)
...
![adp](../../../.vuepress/public/image/mysql7-9.png)
...
![adp](../../../.vuepress/public/image/mysql7-10.png)
...
![adp](../../../.vuepress/public/image/mysql7-11.png)

可以看到，(c=10,id=30）之后的这个间隙并没有在加锁范围里，因此insert语句插入c=12是可以执行成功的。

这个例子对我们实践的指导意义就是，**在删除数据的时候尽量加limit**。这样不仅可以控制删除数据的条数，让操作更安全，还可以**减小加锁的范围**。
...
![adp](../../../.vuepress/public/image/mysql7-12.png)
...
![adp](../../../.vuepress/public/image/mysql7-13.png)
